...
This file is a sample file to guide through how to use `./global-var.dev`. You can basically copy-paste then edit the rest of this content directly into the target file :
```
